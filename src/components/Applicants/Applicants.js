...
export default {
  ...
  computed: {
    filteredApplicants() {
      const applicants = this.selectedTab === 'vendor' ? this.vendorApplicants : this.stallApplicants
      ...
      return applicants.filter(applicant => {
        ...
        return (
          (applicant.applicant_full_name || applicant.first_name + ' ' + applicant.last_name).toLowerCase().includes(searchLower) ||
          ...
          (applicant.business_category || applicant.business_type)?.toLowerCase().includes(searchLower) ||
