...
<template>
  <v-app>
    ...
    <v-main>
      ...
      <div v-if="!loading && !error">
        <v-row>
          <v-col cols="12">
            ...
            <SearchFilter :stallsData="stallsData" @filtered-stalls="handleFilteredStalls" @show-auction-records="
      ...
      <AddChoiceModal :showModal="showModal" @open-modal="openAddStallModal" @close-modal="closeAddStallModal"
        @stall-added="handleStallAdded" @floor-added="handleFloorAdded" @section-added="handleSectionAdded"
        @show-message="showMessage" @refresh-stalls="refreshStalls" @refresh-data="refreshStalls" />
