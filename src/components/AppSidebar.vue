  ...
  data() {
    return {
      ...
      moreItems: [
        ...
        { id: 8, icon: "mdi-account-multiple", name: "Inspectors", active: false },
        { id: 9, icon: "mdi-account-cash", name: "Collectors", active: false },
        { id: 10, icon: "mdi-store", name: "Stalls", active: false },
      ],
    };
  },
  watch: {
