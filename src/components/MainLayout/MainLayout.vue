...
export default {
  ...
  data() {
    return {
      ...
      menuItems: [
        ...
        { id: 4, icon: "mdi-chart-line", name: "Reports", route: "/reports" },
  ...
  methods: {
    ...
    handleNotificationClick() { console.log("Notification clicked"); },
    handleProfileClick() { console.log("Profile clicked"); },
    handleSettingsClick() { console.log("Settings clicked"); },
    handleLogoutClick() { console.log("Logout clicked"); },
  },
};
</script>
...
.main-content::-webkit-scrollbar-thumb { background: #c1c1c1; border-radius: 3px; }
.main-content::-webkit-scrollbar-thumb:hover { background: #a8a8a8; }
@media (max-width: 960px) { .main-wrapper { margin-left: 60px; } .main-content { padding: 16px; } }
@media (max-width: 600px) { .main-wrapper { margin-left: 50px; } }
</style>
