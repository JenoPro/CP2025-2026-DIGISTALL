<template>
    <div>
                ...
                <v-card-text class="pa-8">
                    <v-row dense>
                        ...
                        <v-col cols="12" sm="6" md="4">
                            <v-card class="choice-card stall-card" :class="{ 'choice-card-hover': !loading }"
                                @click="!loading && selectAddStall()" :disabled="loading" elevation="4" role="button"
                                :aria-label="'Add a new stall'" tabindex="0"
                                @keydown.enter="!loading && selectAddStall()"
                                @keydown.space="!loading && selectAddStall()">
                                <div class="choice-card-content">
                                    <div class="choice-icon-container stall-icon">
                                        <v-icon size="52" color="white">mdi-store</v-icon>
                                    </div>
                                    <h3 class="choice-title">Add Stall</h3>
                                    <p class="choice-description">
                                        Add a new stall to an existing floor and section. Configure stall details,
                        ...
                        <v-col cols="12" sm="6" md="4">
                            <v-card class="choice-card floor-section-card" :class="{ 'choice-card-hover': !loading }"
                                @click="!loading && selectAddFloorSection()" :disabled="loading" elevation="4"
                                role="button" :aria-label="'Add floor and section'" tabindex="0"
                                ...
                                <div class="choice-card-content">
                                    <div class="choice-icon-container floor-section-icon">
                                        <v-icon size="52" color="white">mdi-domain</v-icon>
                                    </div>
                                    <h3 class="choice-title">Add Floor & Section</h3>
                                    <p class="choice-description">
                                        Create new floors and sections first. This should be done before adding stalls
                                        to organize your marketplace.
                                    </p>
                                    <div class="choice-features">
                                        <div class="feature-item">
                        ...
                        <v-col cols="12" sm="6" md="4">
                            <v-card class="choice-card view-card" :class="{ 'choice-card-hover': !loading }"
                                @click="!loading && selectViewFloorsSections()" :disabled="loading" elevation="4"
                                role="button" :aria-label="'View existing floors and sections'" tabindex="0"
                                ...
                                <div class="choice-card-content">
                                    <div class="choice-icon-container view-icon">
                                        <v-icon size="52" color="white">mdi-view-list</v-icon>
                                    </div>
                                ...
                                <div class="choice-card-overlay">
                                    <v-btn color="warning" class="choice-btn" :loading="loading" :disabled="loading">
                        ...
                        <v-col cols="12">
                            <v-alert variant="tonal" class="helper-alert" density="compact">
                                <div class="d-flex align-center">
                                    <div>
                                        <strong>Tip:</strong> Create floors and sections first, then add stalls to them.
                                        This ensures proper organization of your marketplace structure.
                                    </div>
                                </div>
                            </v-alert>
                        </v-col>
        ...
        <!-- Add Stall Modal -->
        <AddAvailableStall :showModal="showAddStallModal" @close-modal="closeAddStallModal"
            @stall-added="handleStallAdded" @show-message="handleShowMessage" @refresh-stalls="handleRefreshStalls" />

        <!-- Add Floor & Section Modal -->
        <AddFloorSection :showModal="showAddFloorSectionModal" @close-modal="closeAddFloorSectionModal"
            @floor-added="handleFloorAdded" @section-added="handleSectionAdded" @show-message="handleShowMessage"
            @refresh-data="handleRefreshData" />

        <!-- View Floors & Sections Modal -->
        <ViewFloorsSections :showModal="showViewFloorsSectionsModal" @close-modal="closeViewFloorsSectionsModal"
            @show-message="handleShowMessage" @refresh-data="handleRefreshData"
        ...
        <div class="floating-button-container">
            ...
            <v-tooltip location="left">
                <template v-slot:activator="{ props }">
                    <v-btn fab color="primary" class="add-btn" :class="{ 'glow-effect': !showModal }"
                        @click="openChoiceModal" v-bind="props" :aria-label="'Add or View Stalls, Floors & Sections'"
                        role="button">
