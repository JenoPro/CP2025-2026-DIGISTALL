        ...
        <div class="search-wrapper">
            ...
            <div class="filter-container" ref="filterContainer">
                <button class="filter-btn" :class="{ 'filter-active': showFilters }" @click="toggleFilter">
                    ...
                    Filter
                    <v-icon :icon="showFilters ? 'mdi-chevron-up' : 'mdi-chevron-down'" size="small"
                        class="ml-1"></v-icon>
                </button>
                        ...
                        <div class="filter-card">
                            ...
                            <div class="filter-content">
                                ...
                                <div class="filter-group">
                                    ...
                                    <v-select v-model="selectedFloor" :items="floorOptions" variant="outlined"
                                ...
                                <div class="filter-group">
                                    ...
                                    <v-select v-model="selectedSection" :items="sectionOptions" variant="outlined"
                                        density="comfortable" clearable hide-details
