          ...
          <v-row>
            <v-col cols="12">
              ...
              <div class="page-header mb-6">
                <h2 class="text-h4 font-weight-bold">Branch Management Dashboard</h2>
                <p class="text-subtitle-1 text-grey-600 mt-2">Overview of branch operations and key metrics</p>
              </div>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-card class="metric-card" elevation="2">
                    <v-card-text class="metric-content">
                      ...
                      <div class="metric-body">
                        <v-icon size="48" color="success" class="metric-icon">mdi-account-group</v-icon>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-card class="metric-card" elevation="2">
                    <v-card-text class="metric-content">
                      ...
                      <div class="metric-body">
                        <v-icon size="48" color="warning" class="metric-icon">mdi-currency-php</v-icon>
                      ...
                      <v-table class="custom-table">
                        ...
                        <tbody>
                          <tr v-for="payment in recentPayments" :key="payment.id">
                            ...
                            <td class="text-success font-weight-bold">₱{{ payment.amount.toLocaleString() }}</td>
                      ...
                      <v-table class="custom-table">
                        ...
                        <tbody>
                          <tr v-for="collector in activeCollectors" :key="collector.id">
                            ...
                            <td class="text-primary font-weight-bold">{{ collector.collections }}</td>
                            <td>
                              <v-chip 
                                :color="collector.status === 'Active' ? 'success' : 'warning'" 
                                size="small" 
                                variant="flat"
                              >
                                {{ collector.status }}
                      ...
                      <v-table class="custom-table">
                        ...
                        <tbody>
                          <tr v-for="stall in stallOverview" :key="stall.id">
                            <td class="font-weight-bold text-primary">{{ stall.stallId }}</td>
                            <td class="font-weight-medium">{{ stall.stallholder }}</td>
                            <td class="text-grey-600">{{ stall.location }}</td>
                            <td class="text-success font-weight-bold">₱{{ stall.monthlyFee.toLocaleString() }}</td>
