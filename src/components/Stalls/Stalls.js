...
import AddChoiceModal from './StallsComponents/ChoicesModal/AddChoiceModal.vue'
  ...
  methods: {
    ...
    transformStallData(stall) {
      ...
      return {
        ...
        // NEW HIERARCHICAL FIELDS - From joined tables
        ...
        // Branch manager info from joined data
        managerName:
