  ...
  methods: {
    ...
    createCollectorChart() {
      try {
        ...
        const collectorData = this.activeCollectors.map((collector) => ({
          name: collector.name.split(" ")[0], // First name only for cleaner display
            ...
            datasets: [
              {
                ...
                borderColor: ["#2196f3", "#4caf50", "#ff9800", "#9c27b0", "#f44336"],
                borderWidth: 2,
                borderRadius: 6,
                borderSkipped: false,
              },
              ...
              tooltip: {
                ...
                callbacks: {
                  title: function (context) {
                    ...
                    return (
                      collectorData[index].name + " (" + collectorData[index].area + ")"
                    );
                  },
                  label: function (context) {
    ...
    createPlaceholderCharts() {
      ...
      if (paymentCanvas) {
        ...
        ctx.fillText(
          ...
          paymentCanvas.width / 2,
          paymentCanvas.height / 2
        );
      }
      ...
      if (occupancyCanvas) {
        ...
        ctx.fillText(
          "Occupancy Chart",
          occupancyCanvas.width / 2,
          occupancyCanvas.height / 2
        );
      }
    },
